...
#####################################################################
HEADERS := $(wildcard *.h)
SRC := $(filter-out wasm_api.c test_stc12.c test_blink.c test_adc.c test_integration.c test_multi_when.c test_suite.c test_bench.c test_debug.c test_cycles.c test_mass.c test_soak.c test_adc_oracle.c test_tone_oracle.c test_pca_pwm_oracle.c trace.c, $(wildcard *.c))
OBJ := $(SRC:.c=.o)
...
test_pca_pwm_oracle: test_pca_pwm_oracle.c $(CORE_SRC) $(HEADERS)
	$(CC) $(CFLAGS) -o $@ test_pca_pwm_oracle.c $(CORE_SRC) -lm
...
test: test_stc12 test_blink test_adc test_integration test_multi_when test_suite test_debug test_cycles test_mass test_soak test_adc_oracle test_tone_oracle test_pca_pwm_oracle test-images
	...
	./test_tone_oracle
	@echo ""
	@echo "=== PCA/PWM duty cycle oracle ==="
	./test_pca_pwm_oracle
